  ...
  data () {
    return {
      options: {
        ...
        anchors: ['Introduction', 'Consommations', 'Comparaisons·des·consommations', 'Footer'],
        navigation: true,
        navigationPosition: 'right',
        navigationTooltips: ['Introduction', 'Consommations', 'Comparaisons des consommations', 'Footer'],
        scrollOverflow: true,
